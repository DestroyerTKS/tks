...
module.exports.run = (bot, message, args) => {
  ...
  msgArray.push(`To see what I can do, use tkshelp`);
  msgArray.push(`My invocation method is using prefixes, currently, I only respond to messages beginning with tks`);
